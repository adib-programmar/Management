...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto mt-5">
        <h2 class="text-2xl">Created Classes</h2>
        <ul class="list-group mt-5">
            <?php while ($class = $classes->fetch_assoc()): ?>
                <li class="list-group-item bg-gray-800 mb-2 rounded p-4">
                    <h3 class="text-xl"><?= htmlspecialchars($class['class_name']) ?></h3>
                    <p><strong>Class Code:</strong> <?= htmlspecialchars($class['class_code']) ?></p>
                    <a href="manage_dues.php?class_id=<?= $class['id'] ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-2 inline-block">Manage Dues</a>
                    <a href="publish_results.php?class_id=<?= $class['id'] ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2 inline-block">Publish Results</a>
