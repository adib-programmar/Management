...
<body class="bg-gray-900 text-gray-100">
    ...
    <div class="container mx-auto mt-4 p-4">
            ...
            <div class="chat-container scrollbar-hide">
                <?php while ($msg = $messages->fetch_assoc()): ?>
                    <div class="flex <?= $msg['user_id'] == $_SESSION['user_id'] ? 'justify-end' : 'justify-start' ?> mb-4">
                        <div class="message-bubble <?= $msg['user_id'] == $_SESSION['user_id'] ? 'admin' : 'other' ?>">
        ...
        <a href="view_classes.php" class="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mt-4 inline-block transition duration-300">
